        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    ...
                    <form method="GET" action="{{ route('admin.users.eliminados') }}" class="flex flex-col md:flex-row md:items-center gap-4 mb-6">
                        <input
                            type="text"
                            name="search"
        ...
        <div class="bg-white w-full max-w-lg p-6 rounded-lg shadow-2xl space-y-4">
            ...
            <div class="bg-red-50 border border-red-200 rounded p-4">
                <p class="text-sm text-red-700">
                    <strong>¡ATENCIÓN!</strong> Esta acción es irreversible. El usuario <strong id="forceDeleteUserName"></strong> (<span id="forceDeleteUserEmail"></span>) será eliminado permanentemente del sistema junto con sus facturas registradas.
                </p>
            </div>
