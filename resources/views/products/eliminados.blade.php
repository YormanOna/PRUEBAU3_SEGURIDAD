    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                <i class="fas fa-trash-alt mr-2"></i> Productos Eliminados
            </h2>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    ...
                    <form method="GET" action="{{ route('products.eliminados') }}" class="flex flex-col md:flex-row md:items-center gap-4 mb-6">
                        <input
                            type="text"
                            name="search"
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $product->deleted_at->format('d/m/Y H:i') }}</td>
                    ...
                    <div class="text-center py-12">
                        ...
                        <p class="text-gray-500 text-lg">No hay productos eliminados en el sistema.</p>
                    </div>
                    @endif
                </div>
            </div>
    ...
    <div id="restoreModal" class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-60 hidden">
        <div class="bg-white w-full max-w-lg p-6 rounded-lg shadow-2xl space-y-4">
            ...
            <p class="text-sm text-gray-600">
                Está a punto de restaurar el producto: <strong id="restoreProductName"></strong>
            </p>
            <form id="restoreForm" method="POST">
                ...
                <div class="flex justify-end gap-2">
                    ...
                    <button
                        ...
                        <i class="fas fa-undo mr-2"></i>Restaurar Producto
                    </button>
                </div>
            </form>
        </div>
        ...
        <div class="bg-white w-full max-w-lg p-6 rounded-lg shadow-2xl space-y-4">
            ...
            <div class="bg-red-50 border border-red-200 rounded p-4">
                <p class="text-sm text-red-700">
                    <strong>¡ATENCIÓN!</strong> Esta acción es irreversible. El producto <strong id="forceDeleteProductName"></strong> será eliminado permanentemente del sistema junto con las facturas asociadas.
                </p>
            </div>
